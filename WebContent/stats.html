...
<html data-wf-site="54eb722519500e4473ec8320" data-wf-page="54f8edcf00343eb714035954">
<head>
  <meta charset="utf-8">
  <title>Stats - Game Go!</title>
  ...
  <div class="w-container stats-container">
    ...
    <div class="w-row">
      <div class="w-col w-col-6">
        <div class="stat-category"><strong>Weekly Profit <br>Monthly Profit:<br>Annual Profit:<br><br>Previous Week Profit:<br>Previous Month Profit:<br>Previous Annual Profit:<br><br></strong>
        </div>
      </div>
      <div class="w-col w-col-6">
        <div class="numbers-block">$125
          <br>$356
          <br>$2323232
          <br>
          <br>$989
    ...
    <div class="w-form">
      <form class="w-clearfix stat-month-year-selector" id="email-form" name="email-form" data-name="Email Form">
        <div class="select-month-text"><strong>Select Month</strong>
        </div>
        <select class="w-select stat-month" id="field" name="field">
        ...
        <select class="w-select stat-year" id="field-2" name="field-2"></select>
